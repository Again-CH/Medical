...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_conversation_memory_thread_id"), "conversation_memory", ["thread_id"], unique=False
    )
    op.create_table(
        "doctors",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_symptom_dept_map_keyword"), "symptom_dept_map", ["keyword"], unique=False
    )
    op.create_table(
        "vital_signs",
        sa.Column("id", sa.Integer(), nullable=False),
